...
# Khi dùng named volumes, thư mục uploads/cache có thể bị mount lại thành root.
# Entry point này tạo lại thư mục cần thiết và cấp quyền mỗi lần container khởi động.
